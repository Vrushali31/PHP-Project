...
<body>
      ...
      <div class="topnav">
    <div class="logo"><a href="index.php"><img class="l" src="Logo.png"></a></div>
  ...
  <div class="cart">
    ...
    <a href="cart.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart<div class="count"><?php if(isset($_SESSION["login"]) ){ if(isset($_SESSION["cart"]["$email"]))if(count($_SESSION["cart"]["$email"])!=0 )  echo  count($_SESSION["cart"]["$email"]); }else {echo "0";}
  ?></div> </a>
 </div>
...
<h4 id="end"></h3>
  ...
  <hr>  
    ...
    <a href="vegetables and fruits.php"><div class="grid-item"><img src="images\vegetable.png" alt="image" class="image"><br><div style=color:black>Fruits & Vegetables</div><br></div></a>
    <a href="Packaged Items.php"> <div class="grid-item"><img src="images\staple.png" alt="image" class="image"><br><div style=color:black>Groceries</div><br></div></a>
    <a href="Bakery.php"><div class="grid-item"><img src="images\bread2.png" alt="image" class="image"><br><div style=color:black>Bakery</div><br></div>  </a>
    <a href="Houshold Items.php"><div class="grid-item"><img src="images\household2.png" alt="image" class="image"><br><div style=color:black>Household Items</div><br></div></a>
    <a href="product_pc.php"><div class="grid-item"><img src="images\personal_care3.png" alt="image" class="image"><br><div style=color:black>Personal Care</div><br></div></a>
    <a href="product_b.php"> <div class="grid-item"><img src="images\beverages.png" alt="image" class="image"><br><div style=color:black>Beverages</div><br></div>  </a>
    <a href="product_n.php"> <div class="grid-item"><img src="images\non_veg.png" alt="image" class="image"><br><div style=color:black>Eggs & Non Veg</div><br></div></a>
      ...
      <div class="container">
        <div class="row">
         ...
         <a href="index.php">Nature's Closet</a>.
            </p>
          </div>
