...
// echo count($_SESSION["cart"]["$email"]);
$i=0;
$q=function()
{
	global $i;
...
<div class="logo"><a href="index.php"><img class="l" src="Logo.png"></a></div>
  ...
  <div class="cart">
    ...
    <a class="active" href="cart.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart<div class="count"> <?php if(isset($_SESSION["login"]) ){ if(isset($_SESSION["cart"]["$email"]))if(count($_SESSION["cart"]["$email"])!=0 )  echo  count($_SESSION["cart"]["$email"]); }else {echo "0";}
  ?></div></a>
 </div>
